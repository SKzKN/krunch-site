...
const STRINGS = {
  en: {
    ...
    notifyTitle: 'Follow along until we launch',
    notifyCta: 'Follow on Facebook',
  ...
  et: {
    ...
    notifyEyebrow: 'Peagi tulemas',
    notifyTitle: 'J\u00e4lgi meid',
    notifyCta: 'J\u00e4lgi Facebookis',
